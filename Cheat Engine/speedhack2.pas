...
uses
  {$if not defined(windows) and not defined(darwin) and not defined(jni)}linuxmemoryapi,{$endif} Classes,LCLIntf, SysUtils, NewKernelHandler,CEFuncProc, symbolhandler, symbolhandlerstructs,  lua, lauxlib, lualib,
